...
def setup_cfg(args):
    ...
    if cfg.DATASET.NAME== "SUN397" or cfg.DATASET.NAME == "ImageNet":
        cfg.OPTIM.MAX_EPOCH = 20

    if cfg.DATASET.NAME == "EuroSAT" or cfg.DATASET.NAME == "FGVCAircraft":
        cfg.OPTIM.MAX_EPOCH = 150

    if cfg.DATASET.NAME== "OxfordFlowers" or cfg.DATASET.NAME == "StanfordCars":
